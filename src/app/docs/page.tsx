...
export default function DocumentationPage() {
	return (
		<div className="col-span-6 w-full">
			<h1 className="text-xl md:text-3xl mb-5 font-bold">Documentations</h1>
			...
			<ItemGroup className=" p-5 mt-10 space-y-5 w-full md:w-2/3">
				...
				<Item variant={"outline"} className="">
					<ItemContent>
						<ItemTitle>Add tenants</ItemTitle>
						<ItemDescription>
