...
const Header = () => {
	...
	return (
		<header className="w-full p-5 py-2  border-[1px]  mx-auto shadow-sm flex justify-start gap-2 items-center bg-gradient-to-e from-green-600 via-green-400 to-green-600 ">
